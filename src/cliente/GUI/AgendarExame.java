...
public class AgendarExame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        exame.setFont(new java.awt.Font("Ubuntu", 0, 18)); // NOI18N
        exame.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--" }));
        getContentPane().add(exame);
        exame.setBounds(190, 80, 400, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(exame.getSelectedItem().equals("--") || cpf.getText().isBlank() || telefone.getText().isBlank() ||
            ...
            try {
                ...
                switch(op){
                    case "ok":
                        JOptionPane.showMessageDialog(null,"Exame agendado com sucesso!", "Info" ,JOptionPane.INFORMATION_MESSAGE);
                        break;
                    case "datahorario":
                        JOptionPane.showMessageDialog(null,"Já existe um exame marcado para este horário. Tente outro!", "Info" ,JOptionPane.INFORMATION_MESSAGE);
                        break;
                }
    ...
    private javax.swing.JComboBox<String> exame;
