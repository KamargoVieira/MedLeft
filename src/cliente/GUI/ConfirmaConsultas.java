 ...
 */
public class ConfirmaConsultas extends javax.swing.JFrame {

    /**
     * Creates new form ConfirmaConsultas
     */
    public ConfirmaConsultas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1196, 790));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmaConsultas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmaConsultas().setVisible(true);
            }
        });
    }
